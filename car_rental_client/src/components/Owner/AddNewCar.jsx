...
// Custom control for centering to marker
function CenterToMarkerControl({ position, onCenter }) {
  const map = useMap();
  ...
  React.useEffect(() => {
    ...
    centerControl.onAdd = function () {
      ...
      div.innerHTML =
        '<button type="button" title="Center to marker"><i class="ri-focus-3-line"></i></button>';
  ...
  return (
    <div>
      <div className="location-search-container">
        <div className="search-input-group-enhanced">
          <div className="search-input-wrapper">
            <i className="ri-map-pin-line search-icon-large"></i>
            <input
              type="text"
              className="form-control search-input-large"
              placeholder="123 Nguyen Van Linh St, Da Nang, Vietnam"
              value={search}
      ...
      >
        ...
        />
        <CenterToMarkerControl onCenter={handleFlyToMarker} />
      </MapContainer>
